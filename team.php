        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-10">
            <?php foreach ($teamData['support_team'] as $member): ?>
                <div class="group bg-white rounded-3xl p-8 border-2 border-blue-100 text-center shadow-sm transition-all duration-300 hover:-translate-y-3 hover:shadow-xl hover:border-blue-400">
                    ...
                    <?php else: ?>
                        <p class="text-gray-400 text-sm italic">📞 XXXXXXXXXX</p>
                    <?php endif; ?>

                    
                    <p class="mt-3 text-xs text-blue-600 flex item-center gap-2 justify-center"><svg xmlns="http://www.w3.org/2000/svg" class="h-5" viewBox="0 0 512 512"><path d="M48 64c-26.5 0-48 21.5-48 48 0 15.1 7.1 29.3 19.2 38.4l208 156c17.1 12.8 40.5 12.8 57.6 0l208-156c12.1-9.1 19.2-23.3 19.2-38.4 0-26.5-21.5-48-48-48L48 64zM0 196L0 384c0 35.3 28.7 64 64 64l384 0c35.3 0 64-28.7 64-64l0-188-198.4 148.8c-34.1 25.6-81.1 25.6-115.2 0L0 196z"/></svg><?= $member['email'] ?></p>
                </div>
            <?php endforeach; ?>
        </div>
    </div>
